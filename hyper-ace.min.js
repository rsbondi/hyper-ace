...
d.column);var e=this.ranges[b.getAttribute("data-session")][a];c.selection.setRange(new g(d.row,d.column,d.row,e.end.column+d.column-e.start.column));c=this.target.getElementsByTagName("div");for(l in c)this.options.lineclass==c[l].className&&(c[l].className="");b.className=this.options.lineclass},_acebox:function(){var a=this;ace.config.loadModule("ace/ext/searchbox",function(b){b.Search(a.editor);a.textbox=a.editor.container.getElementsByClassName("ace_search_field")[0];a.textbox.id="hyperbox";
a.textbox.addEventListener("keyup",function(b){9==b.keyCode&&(a.searchMultiSession?a.searchSessions():a.search())});a.editor.container.getElementsByClassName("ace_search")[0].style.display="none";a.options&&"function"==typeof a.options.load&&a.options.load(b)})},setSession:function(a){this.editor.setSession(this.sessions[a]);this.currentSession=a;console.log("session changed to: "+a)},htmlEncode:function(a){return a.replace(/&/g,"&amp;").replace(/ /g,"&nbsp;").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/</g,
